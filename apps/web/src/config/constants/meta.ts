...
export const DEFAULT_META: PageMeta = {
  ...
  image: 'https://app.zahoo.io/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for ZahooSwap exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for ZahooSwap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for ZahooSwap exchanges.' },
    ...
    defaultTitleSuffix: t('ZahooSwap'),
  }
}
